...
describe("node module loader test", () => {
    ...
    it("cache test", (done) => {
        let loader = new NodeModuleLoader(module);
        loader.resolve("./ModuleLoaderSpec")
            .subscribe(p => {
                expect(loader.cache(p))
                    .toBeTruthy();
                done();
            });
    });
    ...
    it("reload test", (done) => {
        ...
        loader.reload("./sample")
            ...
            .subscribe(data => {
                let orig = data[0];
                let now = data[1];
                expect(require("./sample")
                        .Hello === now.Hello)
                    .toBeFalsy()
                expect(now.date !== date)
                    .toBeTruthy();
                done();
            });
    });
